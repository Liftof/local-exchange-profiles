...
The source repository and frozen artifact release are available at
\url{https://github.com/Liftof/local-exchange-profiles} and
\url{https://github.com/Liftof/local-exchange-profiles/releases/tag/v1.0.0}.
Original code is released under Apache-2.0; the manuscript, original
documentation, generated data, CNF instances, and proof artifacts are released
under CC-BY-4.0. Third-party material retains its original license.
